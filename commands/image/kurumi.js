...
module.exports = {
    ...
    aliases: [`kurumi`],
    category: `image`,
    description: `Ảnh kurumi`,
    usage: `${process.env.DISCORD_PREFIX}kurumi`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/kurumi?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh kurumi | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

...
module.exports = {
    ...
    aliases: [`japcosplay`],
    category: `image`,
    description: `Ảnh japan cosplay`,
    usage: `${process.env.DISCORD_PREFIX}japcosplay`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/japcosplay?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh japan cosplay | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

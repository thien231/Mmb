...
module.exports = {
    ...
    aliases: [`aqua`],
    category: `image`,
    description: `Ảnh aqua`,
    usage: `${process.env.DISCORD_PREFIX}aqua`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/aqua?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh aqua | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

...
module.exports = {
    ...
    aliases: [`gainhat`],
    category: `image`,
    description: `Ảnh gái nhật`,
    usage: `${process.env.DISCORD_PREFIX}gainhat`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/gainhat?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh gái nhật | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

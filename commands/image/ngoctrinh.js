...
module.exports = {
    ...
    aliases: [`ngoctrinh`],
    category: `image`,
    description: `Ảnh ngọc trinh`,
    usage: `${process.env.DISCORD_PREFIX}ngoctrinh`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/ngoctrinh?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh ngọc trinh | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

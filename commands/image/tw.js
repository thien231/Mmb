...
module.exports = {
    ...
    aliases: [`tw`],
    category: `image`,
    description: `Ảnh gái trung`,
    usage: `${process.env.DISCORD_PREFIX}tw`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/tw?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh gái trung | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

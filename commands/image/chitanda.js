...
module.exports = {
    ...
    aliases: [`chitanda`],
    category: `image`,
    description: `Ảnh chitanda`,
    usage: `${process.env.DISCORD_PREFIX}chitanda`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/chitanda?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh chitanda | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

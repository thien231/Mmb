...
module.exports = {
    ...
    aliases: [`rushia`],
    category: `image`,
    description: `Ảnh rushia`,
    usage: `${process.env.DISCORD_PREFIX}`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/rushia?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh rushia | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

...
module.exports = {
    ...
    aliases: [`umaru`],
    category: `image`,
    description: `Ảnh umaru`,
    usage: `${process.env.DISCORD_PREFIX}umaru`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/umaru?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh umaru | Admin: ${HungChannels.tag}`)
            .setImage(image.url)

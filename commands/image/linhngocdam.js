...
module.exports = {
    ...
    aliases: [`linhngocdam`],
    category: `image`,
    description: `Ảnh linh ngọc đàm`,
    usage: `${process.env.DISCORD_PREFIX}linhngocdam`,
    run: async (client, message, args) => {
        const url = 'http://imgs-api.herokuapp.com/linhngocdam?apikey=mk001';
        let image, response;
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`Ảnh linh ngọc đàm | Admin: ${HungChannels.tag}`)
            .setImage(image.url)
